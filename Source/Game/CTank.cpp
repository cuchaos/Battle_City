...
CTank::CTank() :Width(32), Height(32) {
	_FrameTime = 0;							// counter
	_Frameindex = 4;						// animation frame (0 is east,1 south, 2 west,3 north)*2
	                                                            /*why not enum and what is `*2` ?*/
	_FrameSecond = 2;						// antmation cycle time
	_LocationDistance = Height/4;			
	_MovementSpeed = 4;						
	_IfFire = false;
	_IfBattle = false;
